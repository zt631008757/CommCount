...
import com.android.diandezhun.bean.BannerInfo;
import com.android.diandezhun.ui.activity.WebViewActivity;
import com.android.diandezhun.util.RouterUtil;
...
public class MyBannerImageAdapter extends BannerAdapter<BannerInfo, BannerImageHolder> {
    ...
    public void onBindView(BannerImageHolder holder, BannerInfo data, int position, int size) {
        GlideUtil.displayImage(holder.itemView.getContext(), data.picUrl, holder.imageView, R.drawable.ico_default_banner);
...
//                    holder.itemView.getContext().startActivity(intent);
                ...
                } else if (!TextUtils.isEmpty(data.H5Url)) {
                    WebViewActivity.startActivity(context, "", data.H5Url);
                }
            }
        });
    }
