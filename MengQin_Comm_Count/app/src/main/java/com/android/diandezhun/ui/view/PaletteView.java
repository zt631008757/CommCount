...
public class PaletteView extends View {
    ...
    private int strokeWidth = 10;       //写字笔宽度
    private int mEraserSize = 90;    //橡皮擦宽度
    private int mPenAlpha = 255;       //画笔透明度
    ...
    public final RectF mDirtyRect = new RectF();
